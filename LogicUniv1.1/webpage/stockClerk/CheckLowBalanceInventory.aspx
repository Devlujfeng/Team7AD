	...
	<div class="templatemo-container">
		<div class="col-lg-3 col-md-3 col-sm-3  black-bg left-container" id="leftlayer">
			...
			<ul class="nav nav-stacked templatemo-nav">
				  ...
				  <li><a href="ClerkInventory.aspx" class="active"><i class="fa fa-shopping-cart fa-medium"></i>Inventory</a></li>
		...
		<div class="col-lg-9 col-md-9 col-sm-9  white-bg right-container" id="rightlayer">
			...
			<div class="tm-right-inner-container" id="prelayer">
                ...
                &nbsp
                <asp:Button ID="btn_reorder" CssClass="btn btn-sm btn-info" runat="server" Text="Reorder" OnClick="btn_reorder_Click" />
