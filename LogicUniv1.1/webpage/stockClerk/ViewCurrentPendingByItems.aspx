<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewCurrentPendingByItems.aspx.cs" Inherits="LogicUniv1._1.webpage.stockClerk.ViewCurrentPendingByItems" %>
	...
	<div class="templatemo-container">
		...
		<div class="col-lg-9 col-md-9 col-sm-9  white-bg right-container" id="rightlayer">
			...
			<div class="tm-right-inner-container" id="prelayer">    
               <div>
                   <asp:Button ID="btn_byItem" CssClass="btn btn-sm btn-default" runat="server" Text="View by Items" Enabled="False" />
                   <asp:Button ID="btn_byDept"  CssClass="btn btn-sm btn-default"  runat="server" Text="View by Dept" OnClick="btn_byDept_Click" />
               </div>
