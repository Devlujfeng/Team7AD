<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckCurrentDisbursementList.aspx.cs" Inherits="LogicUniv1._1.webpage.stockClerk.CheckCurrentDisbursementList" %>
...
<div class="col-lg-9 col-md-9 col-sm-9  white-bg right-container" id="rightlayer">
     ...
     <script>
         $(function () {
             ...
             var height = $("#prelayer").height() + 1100;
             console.log(height);
