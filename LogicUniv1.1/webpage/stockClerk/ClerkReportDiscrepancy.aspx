        ...
        <asp:GridView ID="Gv1" runat="server" AutoGenerateColumns="False"  width="900px" RowStyle-Height="35px"  HeaderStyle-Height="35px" Font-Size="Small" OnRowDeleting="Gv1_RowDeleting"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Category">
                    <ItemTemplate>
                        <asp:TextBox Enabled="false" ID="Txt_Cposition" runat="server" Text='<%#Eval("Cposition")%>' CssClass="form-control" ></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Description">
                    <ItemTemplate>
                        <asp:TextBox Enabled="false" ID="Txt_UserName" runat="server" Text='<%#Eval("UserName")%>'  CssClass="form-control"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Amount">
                    <ItemTemplate>
                        <asp:TextBox Enabled="false" ID="Txt_Jan" runat="server" Text='<%#Eval("JanCount")%>'  CssClass="form-control"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Unit">
                    <ItemTemplate>
                        <asp:TextBox Enabled="false" ID="Txt_Unit" runat="server" Text='<%#Eval("Count")%>' CssClass="form-control"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Type">
                    <ItemTemplate>
                        <asp:TextBox Enabled="false" ID="Txt_Feb" runat="server" Text='<%#Eval("FebCount")%>' CssClass="form-control"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Remark">
                    <ItemTemplate>
                        <asp:TextBox Enabled="false" ID="Txt_remark" runat="server" Text='<%#Eval("remark")%>' CssClass="form-control"></asp:TextBox>
                    </ItemTemplate>
                </asp:TemplateField>
